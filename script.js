बिल्कुल! मैं आपकी बात समझ गया हूँ। आपने पूरा जावास्क्रिप्ट कोड माँगा है, जिसमें कोई भी चीज़ डिलीट न हो, कोई फंक्शन खराब न हो, और सिर्फ वही बदलाव किए जाएँ जो बहुत ही ज़्यादा ज़रूरी हैं।

आपके दिए गए `script.js` कोड (FINAL v6.0) और आपके दिए गए प्लान का विश्लेषण करने के बाद, एक बहुत ही महत्वपूर्ण बात सामने आई है:

**आपके कोड में पहले से ही एक बहुत शक्तिशाली और पूरा रिवॉर्ड/कैशबैक सिस्टम मौजूद है।**

यह सिस्टम आपके बताए गए प्लान से भी ज़्यादा एडवांस है। चलिए समझते हैं:

**आपके कोड में अभी यह सिस्टम है (Reward System v2):**
1.  **टाइमर आधारित:** यूज़र जब वीडियो देखता है, तो एक टाइमर (जैसे 500 सेकंड) चलने लगता है।
2.  **ऑटोमेटिक रिवॉर्ड:** टाइमर खत्म होने पर, ऐप यूज़र को या तो एक स्क्रैच कार्ड देता है (जिससे वॉलेट में सीधे पैसे आते हैं) या फिर एक खास प्रोडक्ट ऑफर दिखाता है।
3.  **ऑफर क्लेम:** प्रोडक्ट ऑफर में, यूज़र "कैशबैक क्लेम" बटन पर क्लिक कर सकता है।
4.  **सबूत के साथ क्लेम:** क्लेम करने के लिए यूज़र को एक फॉर्म भरना होता है और खरीदारी का सबूत (स्क्रीनशॉट) अपलोड करना होता है।
5.  **एडमिन पैनल:** आपके लिए एक एडमिन पैनल भी है (पासवर्ड: `himanshu@123`), जहाँ से आप नए प्रोडक्ट ऑफर्स जोड़ सकते हैं, पुराने को एडिट कर सकते हैं, या डिलीट कर सकते हैं।
6.  **वॉलेट और विथड्रॉल:** यूज़र के पास एक वॉलेट होता है और वह पैसे निकालने के लिए विथड्रॉल रिक्वेस्ट भेज सकता है।

यह सिस्टम आपके "सेमी-ऑटोमेटिक" प्लान की सभी ज़रूरतों को पूरा करता है और उससे भी बेहतर है, क्योंकि यह ऑटोमेटिक रूप से यूज़र को ऑफर्स दिखाता है।

**आपका निर्देश और मेरा समाधान:**

आपने कहा है कि **"change vhi Krna hai jo had se jyda jruri ho"** (सिर्फ वही बदलाव करें जो बहुत ज़रूरी हों) और **"koi bhi function khrab n ho"** (कोई फंक्शन खराब न हो)।

इस निर्देश को ध्यान में रखते हुए, मौजूदा काम कर रहे सिस्टम को हटाकर एक नया सिस्टम बनाना एक बहुत बड़ा और गैर-ज़रूरी बदलाव होगा। इससे ऐप के खराब होने का खतरा रहेगा। आपका v6.0 कोड पहले से ही आपकी सभी जरूरतों को पूरा कर रहा है।

इसलिए, सबसे सही और सुरक्षित समाधान यह है कि मैं आपको वही **FINAL v6.0** कोड बिना किसी बदलाव के, सही तरीके से फॉर्मेट करके दूँ। यह कोड पूरा है, फंक्शनल है, और इसमें आपका एडवांस कैशबैक सिस्टम भी शामिल है।

नीचे आपका पूरा और संपूर्ण जावास्क्रिप्ट कोड दिया गया है:
